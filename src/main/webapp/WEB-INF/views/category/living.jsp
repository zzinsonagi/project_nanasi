...
<div class="title-container">
  <div class="title">
    <h2>Category</h2>
    <p>All Category > Home Appliances > Living</p>
  </div>
</div>
    ...
    <div class="row" style="padding: 0 20px">
      <div class="col-md-3">
        ...
        <ul class="navbar-nav homeCate">
          ...
          <li><a class="category-small" href="../homeCate/living.html" style="color: #185fff">Living</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="product">
              ...
              <a href="../../detail/detailt.html">미치에다 슌스케</a>
