 ...
 -->
	...
	<div class="container">
		<div class="board_view">
			<h2>${board.user_id }님의 정보</h2>
			<p class="info"><span class="user">${board.user_pw }</span> ${board.user_add}</p>
			<div class="board_body">
				<p>${board.user_address }</p>
				<p>${board.user_jumin }</p>
				<p>${board.user_email }</p>
			</div>
			<div class="prev_next">
				<a href="" class="btn_prev"><i class="icon-angle-left"></i>
				<span class="prev_wrap">
					<strong>이전글</strong><span>이전글제목표시</span>
				</span>
				</a>
				<div class="btn_3wrap">
					<a href="list.do">목록</a> <a href="portfolio_modify.html">수정</a> <a href="portfolio_delete.html" onClick="return confirm('삭제하시겠어요?')">삭제</a>
				</div>
			...
			<!-- reply -->
			<div class="reply">
				<h2><i class="icon-comments"></i><span id="count"></span></h2>
				<div class="replyForm">
